...
# Bitte ladet die CSV-Dateien aus dem Moodle Kurs oder dem GitHub Repository (https://github.com/hdm-crpr/226305/tree/master/Tutorium) unter „Tutorium“ runter und speichert sie in eurem Working Directory. Bitte verändert nicht den Namen der Dateien. Es müssen .csv Dateien sein.
# Bitte ladet igraph!!!
...
# Wenn ihr die Edge- und Nodelist nicht herunterladen und abspeichern könnt, ladet bitte die Edge- und Nodelist mit diesen Befehlen direkt aus GitHub herunter.

el <- read.csv("https://raw.githubusercontent.com/hdm-crpr/226305/master/Tutorium/18-4-18_Beispiel_Edgelist.csv", header=T, as.is=T, sep = ",")
nl <- read.csv("https://raw.githubusercontent.com/hdm-crpr/226305/master/Tutorium/18-4-18_Beispiel_Nodelist.csv", header=T, as.is=T, sep = ",")
